                ...
                @foreach($notifications as $notification)
                   ...
                   ?>
                    ...
                    <td data-id="{{$notification->id}}" data-url="{{url($notification->url)}}" class="viewnotifications" colspan="2"><a href="javascript:void(0);"  style="text-decoration: none !important;color:black;">
