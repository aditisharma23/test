                ...
                <div class="row">
                    ...
                    <!-- Column -->
					 <div class="col-lg-8 col-xlg-9 col-md-7">
                        ...
                        <h5 class="card-title font-weight-bold b-b pb-2">Subscription Plan</h5>
                        ...
                        <table class="table" id="myTable">
                            ...
                            <tbody class="bg-light">
                                ...
                                <tr> 
                                    <td class="">@if($transaction->amount != '0' && $transaction->transaction_id =='0') Wallet @elseif($transaction->transaction_id != '0') #{{$transaction->transaction_id}} @else Free @endif</td>
                                    <td class="">{{$transaction->title}}</td>
                                    <td class="">${{$transaction->amount}}</td>
                                    <td class="">{{date('d/m/Y',strtotime($transaction->expiry))}}</td>												
                                </tr> 
                                @endforeach
                               @endif
                            </tbody>
