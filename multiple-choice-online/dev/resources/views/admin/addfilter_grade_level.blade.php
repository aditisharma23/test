                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-12 ">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">@if(!empty($c_details)) Edit Grade/Level @else Add Grade/Level @endif</li>
                            ...
                            <div class="card-body userdatabtn-color">
                                <div class="d-flex no-block">
                                    <div>
                                        ...
                                        <h4 class="card-title"><span class="lstick"></span>Edit Grade/Level</h4>
                                        <?php }else{ ?>
                                         <h4 class="card-title"><span class="lstick"></span>Add Grade/Level</h4>
                                         <?php } ?>
                                    </div>
                                </div>
                                
                              <span id="success_msg"></span>
                                <form method="POST" action="javascript:void(0);" name="addgrade" class="mt-4"> 
                                    <div class="row">
                                        <div class="col-md-6">
                                          {{csrf_field()}}
                                        	...
                                        	<p class="error" id="emailErr" style="display:none;">Grade already exists.</p> 
                                            </div>
