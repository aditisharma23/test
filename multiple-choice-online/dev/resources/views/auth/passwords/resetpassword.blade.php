                    ...
                    @endif
						...
						<div class="row">
										...
										<div class="col-lg-6 col-md-6 p-0">
										  ...
										  <form method="POST" data-action="{{ route('resetpassword') }}" data-next="{{ url('/login') }}" class="resetyourpassword">
                                            @csrf
                                            <input type="hidden" name="id" value="@if(!empty($id)){{$id}}@endif">
										  <div class="signmrtp features_border_top ml-3"></div>
										  <p>Please enter your new password and confirm password to reset your password.</p>
                                ...
                                @endif
                                 ...
                                 <input id="password-confirm" type="password" placeholder="Enter Your Confirm Password..."  class="form-control" name="password_confirmation" required>
									 ...
									 <div class=" col-lg-12">
											    <button type="submit" class="btn btn-primary loginbtn resetpass">  {{ __('Reset Password') }}</button>
											    </form>
...
$('.resetyourpassword').validate({
   rules: {
       ...
       $('.resetpass').html('<i class="fa fa-spinner fa-spin"></i> Porcessing...');
       submitforms('resetyourpassword','resetpass');
