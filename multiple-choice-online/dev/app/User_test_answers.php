...
class User_test_answers extends Authenticatable
{
   ...
   protected $table = "user_test_answers";
    protected $fillable = [
        'test_id','question_id','answer','user_id','suggested_answer','comment'
    ];
     ...
     */
           ...
           public static function updateoption2($condition='',$query='')
           {
            ...
            { 
                ...
                $data =  $data->select('question_answers.*', 'user_test_answers.*','user_test_answers.answer as myanswer','question_answers.answer as realanswer','user_test_answers.id as tid');
                $data =  $data->get();
                return $data;
            }
}
