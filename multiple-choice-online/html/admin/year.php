            ...
            <div class="container-fluid ">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-12 ">
                        ...
                        <a href="addfilter-year.php" class="btn btn-info btn-rounded float-right btn-sm m-0"><i class="mdi mdi-plus"></i> Add Year</a>
                    </div>
                    <!-- <div class=""> -->
                                    ...
                                    <table id="myTable" class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="addfilter-year.php" class="btn-info mr-1"><i class="mdi mdi-pencil"></i></a>
